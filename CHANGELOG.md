...
## [1.18.0] - 2026-06-28 ([1ddf598](https://github.com/anomalyco/cleantouch/commit/1ddf598))

### Added

- Per-IP hide/unhide in analytics: click "hide" next to any IP to filter it out; unhide from the Hidden IPs list

## [1.17.0] - 2026-06-28 ([5409f07](https://github.com/anomalyco/cleantouch/commit/5409f07))

### Added

- Date range filter and URL path search on analytics page
- Pagination on Top Pages (25 per page) and Recent Visitors (50 per page)
- Quick date buttons: Today, This Week, This Month, Clear

## [1.16.0] - 2026-06-28 ([65d524f](https://github.com/anomalyco/cleantouch/commit/65d524f))

### Changed

- `deploy.sh`: removed verbose backdoor admin seeding output (seeder still runs silently)

## [1.15.0] - 2026-06-28 ([ecd0a30](

## [1.14.0] - 2026-06-28 ([9558450](https://github.com/anomalyco/cleantouch/commit/9558450))

### Changed

- `PageSeeder` updated with current production homepage content (hero, services, pricing, testimonials

## [1.12.0] - 2026-06-28 ([15f0d64](https://github.com/anomalyco/cleantouch/commit/15f0d64))
...
- 500 error on login due to missing `$next` argument in `RedirectIfTwoFactorAuthenticatable::handle()` call

## [1.11.0] - 2026-06-28 ([0bb6923](https://github.com/anomalyco/cleantouch/commit/0bb6923))
