...
{{ $includeBots ? 'bg-zine-yellow text-zine-black border-zine-yellow' : 'bg-surface-100 text-surface-700 border-surface-300 hover:bg-surface-200' }}">
            ...
            <a href="{{ request()->fullUrlWithQuery(['show_ips' => $showFullIps ? 0 : 1, 'top_page' => null, 'visitors_page' => null]) }}"
               class="px-3 py-1.5 text-sm font-zine-display tracking-wider border rounded transition-all duration-200 
               {{ $showFullIps ? 'bg-zine-green text-zine-black border-zine-green' : 'bg-surface-100 text-surface-700 border-surface-300 hover:bg-surface-200' }}">
        ...
        <form method="GET" action="{{ route('admin.analytics.index') }}" class="flex flex-wrap items-end gap-3">
            <div>
                ...
                <input type="date" name="start_date" value="{{ $startDate }}"
                       class="px-3 py-1.5 text-sm border rounded bg-surface-100 text-surface-700 border-surface-300">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" name="url_query" value="{{ $urlQuery }}" placeholder="Filter by URL..."
                       class="px-3 py-1.5 text-sm border rounded bg-surface-100 text-surface-700 border-surface-300 w-48">
            </div>
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('admin.analytics.index') }}"
                   class="px-3 py-1.5 text-sm font-zine-display tracking-wider border rounded bg-surface-100 text-surface-700 border-surface-300 hover:bg-surface-200 transition-all duration-200">
                    Clear
                </a>
